...
// TestBug2InvalidGIFData reproduces the critical bug where integration test
// creates malformed GIF data that fails to decode
func TestBug2InvalidGIFData(t *testing.T) {
	...
	// Use the same malformed GIF data from integration test
